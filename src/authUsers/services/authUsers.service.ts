...
} from 'src/clients/dtos/registerClient.dto';
...
export class AuthService {
  ...
  async signIn(signInDto: signInDto): Promise<any> {
    try {
      ...
      const payload = { sub: checkUserEmail.id, email: checkUserEmail.email, role:checkUserEmail.roles };
